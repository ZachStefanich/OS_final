...
### graph.py
graph.py is a bonus program, used to enhance the users understanding of the time taken to run the single threaded tree vs the multithreaded tree. It takes in the csv file generated by the timer.c file, and graphs the results by using pythons matplotlib library.
## Kanban board (tasks)
